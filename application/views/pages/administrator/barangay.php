                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>barangay" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Barangay</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a class="btn btn-primary" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> New Health Center Data</a>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                    if($bgData){
                                        foreach ($bgData as $rs) {
                                            ?>
                                            <tr>
                                                <td><?php echo sprintf("%05d",$rs->idNo);?></td>
                                                <td><?php echo $rs->hcName;?></td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">New Health Center Data</h4>
                ...
                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/barangay_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    <div class="card-body">

                        <div class="form-group">
                            <label for="itemName">Health Center</label>
                            <select class="custom-select form-control" name="hcName">
                                <option>-- Select Health Center -- </option>
                                <?php foreach($hcData as $rs){ ?>
                        ...
                        <div class="form-group">
                            <label for="itemName">Barangay Name</label>
                            <input type="text" class="form-control" id="bName" name="bName" placeholder="Enter Barangay Name ">
                        </div>
