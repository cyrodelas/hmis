                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>consultationt" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a class="btn btn-primary" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> New Consultation Type Data</a>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">File Managment</a></li>
                            <li class="breadcrumb-item active">Consultation Type</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                    if($consultationtData){
                                        foreach ($consultationtData as $rs) {
                                            ?>
                                            <tr>
                                                <td><?php echo sprintf("%05d",$rs->idNo);?></td>
                                                <td><?php echo $rs->cName;?></td>
                                                <th>
                                                    <a href="" class="load_modal_details" data-toggle="modal" data-target=".edit-carousel<?php echo $rs->idNo;?>"> manage</a>
                                                    |
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">New Consultation Type Data</h4>
                ...
                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/consultationt_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="itemName">Name</label>
                            <input type="text" class="form-control" id="sName" name="cName" placeholder="Enter Consultation Type Name">
                        </div>
