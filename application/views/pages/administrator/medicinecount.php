                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>physicalcount" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <div class="card-body">
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/addIncomingData" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    ...
                                    <table id="medicineList" class="mt-4 table table-bordered table-striped">
                                        ...
                                        <?php
                                            if($medicineData){
                                                foreach ($medicineData as $rs) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo sprintf("%05d",$rs->idNo);?></td>
                                                        <td><?php echo $rs->barCode;?></td>
                                                        <td><?php echo $rs->category;?></td>
                                                        <td><?php echo $rs->genericName;?></td>
                                                        <td><?php echo $rs->brandName;?></td>
                                                        <td><?php echo $rs->medtype;?></td>
                                                        <td><?php echo $rs->dosage;?></td>
                                                        <td><?php echo $rs->uom;?></td>
                                                        <td>
                                                            <input type="text" class="form-control" id="medQty" name="medQty" placeholder="Input Quantity">
                                                        </td>
