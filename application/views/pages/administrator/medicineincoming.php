                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>incomingitems" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Incoming Stocks</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>symptoms" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Symptoms</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Medicine Managment</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row pb-3">
                                    <div class="input-group input-group-sm">
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" class="form-control" name="inputMedicineID" id="inputMedicineID" placeholder="Input Barcode">
                                        </div>
                                        <div class="col-md-5">
                                            <input type='hidden' name ="searchsubjecturl" id = "searchMedicineUrl" value="<?php echo base_url();?>administrator/getMedicineInfoSearch">
                                            <button id="searchMedicine" class="btn btn-primary btn-flat col-md-12"> Search </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="medQty" name="medQty" placeholder="Input Quantity"></td>
                                        </tr>
                                    </thead>
                                </table>
                                ...
                                <button id="submitbutton" class="mt-3 btn btn-primary col-md-12">ADD MEDICINE</button>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/addIncomingData" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="itemName">Reference Number</label>
                                                <input type="text" class="form-control" id="referenceNum" name="referenceNum" placeholder="Input Reference Number">
                                            </div>
                                        </div>  
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="itemName">Supplier</label>
                                                <input type="text" class="form-control" id="supplier" name="supplier" placeholder="Input Supplier Name">
                                            </div>
                                        </div> 
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="itemName">Mode of Acquisition</label>
                                                <select class="custom-select form-control" name="acquisition">
                                                    <option>-- Select Mode of Acquisition -- </option>
                                    ...
                                    <table id="medicineList" class="mt-4 table table-bordered table-striped">
                                    ...
                                    <button type="submit" class="mt-3 btn btn-primary col-md-12">SAVE RECORD</button>
                                </form>
                            </div>
...
<script>
    ...
    $('#searchMedicine').click(function(){
        ...
        var searchMed = $('#searchMedicineUrl').val();
        var medicineID = $('#inputMedicineID').val();
        ...
        $.ajax({
            ...
            success: function(data){
                console.log(data);
                $('#inputMedicineID').val("");
                $("#tblbarcode").text(data[0].barCode);
                $("#tblcategory").text(data[0].category);
                $("#tblgeneric").text(data[0].genericName);
                $("#tblbrand").text(data[0].brandName);
                $("#tbltype").text(data[0].medtype);
                $("#tbldosage").text(data[0].dosage);
                $("#tbluom").text(data[0].uom);    
            }});
    }); 

    $('#submitbutton').click(function(){
        var barcode = $('#tblbarcode').text();
        var category = $('#tblcategory').text();
        var generic = $('#tblgeneric').text();
        var brand = $('#tblbrand').text();
        var type = $('#tbltype').text();
        var dosage = $('#tbldosage').text();
        var uom = $('#tbluom').text();
        var qty = $('#medQty').val();
        ...
        var row =  $('#medicineList').DataTable().row.add([barcode, generic + " " + brand, dosage, uom, qty + '<input type="text" style="display:none" name="tableData[]" value="'+ barcode + '+' + qty + '">']).draw();
