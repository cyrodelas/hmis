                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>medicineinfo" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a class="btn btn-primary" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> New Medicine Information Data</a>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Medicine Managment</a></li>
                            <li class="breadcrumb-item active">Medicine Information</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">New Medicine Information Data</h4>
                ...
                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/medicineinfo_add" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="itemDescription">Generic Name</label>
                            <input type="text" class="form-control" id="genericName" name="genericName" placeholder="Enter Generic Name">
                        </div>

                        <div class="form-group">
                            <label for="itemDescription">Brand Name</label>
                            <input type="text" class="form-control" id="brandName" name="brandName" placeholder="Enter Brand Name">
                        </div>

                        <div class="form-group">
                            <label for="itemDescription">Medicine Type</label>
                            <select class="custom-select form-control" name="medtype">
                                <option>-- Select Medicine Type -- </option>
                                <?php foreach($mType as $rs){ ?>
                                    <option value="<?php echo $rs->tName; ?>"><?php echo $rs->tName; ?></option>
                                <?php } ?>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="itemDescription">Dosage</label>
                            <input type="text" class="form-control" id="dosage" name="dosage" placeholder="Enter Dosage">
                        </div>

                        <div class="form-group">
                            <label for="itemDescription">Unit of Measurement</label>
                            <select class="custom-select form-control" name="uom">
                                <option>-- Select Unit of Measurement -- </option>
                                <?php foreach($mUOM as $rs){ ?>
                                    <option value="<?php echo $rs->uName; ?>"><?php echo $rs->uName; ?></option>
                                <?php } ?>
                            </select>
                        </div>
