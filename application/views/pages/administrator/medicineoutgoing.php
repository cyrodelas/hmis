                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>outgoingitems" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Outgoing Stocks</p>
                                </a>
                            </li>
                                ...
                                <div class="row pb-3">
                                    <div class="input-group input-group-sm">
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" class="form-control" name="inputMedicineID" id="inputMedicineID">
                                        </div>
                                        <div class="col-md-5">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="status" name="status" class="form-control col-md-12 col-xs-12">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/addOutgoingData" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <table id="medicineList" class="table table-bordered table-striped">
                                    ...
                                    <button id="" class="mt-3 btn btn-primary col-md-12">SAVE RECORD</button>
...
<script>
    ...
    $('#submitbutton').click(function(){
        ...
        var row =  $('#medicineList').DataTable().row.add([barcode, generic + " " + brand, dosage, uom, qty, reason + '<input type="text" style="display:none" name="tableData[]" value="'+ barcode + '+' + qty + '+' + reason + '">']).draw();
