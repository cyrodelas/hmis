                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>stockstransfer" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Stocks Transfer</p>
                                </a>
                            </li>
                            ...
                            <div class="card-body">
                                <form method="post" id="frm_validation" action="<?php echo base_url();?>administrator/addIncomingData" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="itemName">Transfer to</label>
                                                <select class="custom-select form-control" name="transferTo">
                                                    <option>-- Select Health Center -- </option>
                                                    <?php foreach($transferData as $rs){ ?>
                                                        <option value="<?php echo $rs->hcName; ?>"><?php echo $rs->hcName; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div> 
