            ...
            <div class="container-fluid">
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" id="itemName">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" id="itemDescription">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="font-weight:600; font-size: 1em">Consultation Type Form</h3>
                                <div class="card-tools">
                            ...
                            <div class="card-body">
                                <div class="row">
                                     <div class="col-md-12 text-right">
                                        <button type="submit" class="btn btn-primary ">Proceed to Health Worker Evaluation</button>
                                    </div>
                                </div>
                            </div>
