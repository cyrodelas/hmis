                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemName" placeholder="Enter Last Name" name="patientLastName" value="<?php echo $rs->patientLastName; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter First Name" name="patientFirstName" value="<?php echo $rs->patientFirstName; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter Middle Name" name="patientMiddleName" value="<?php echo $rs->patientMiddleName; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter House No / Lot  No" name="patientHouseNo" value="<?php echo $rs->patientHouseNo; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter Street Name" name="patientStreet" value="<?php echo $rs->patientStreet; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="text" id="dob" class="form-control datetimepicker-input" data-target="#reservationdate" name="patientBirthDate" value="<?php echo date_format(new DateTime($rs->patientBirthDate), "Y-m-d"); ?>">
                                    ...
                                    <div class="col-md-1">
                                            ...
                                            <input disabled type="text" class="form-control" id="patientAge" placeholder=""  value="<?php $dob = new DateTime($rs->patientBirthDate); $now = new DateTime();  $diff = $now->diff($dob); echo $diff->y; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter Birth Place" name="patientBirthPlace" value="<?php echo $rs->patientBirthPlace; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter Occupation" name="patientOccupation" value="<?php echo $rs->patientOccupation; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input style="text-transform:uppercase" type="text" class="form-control" id="itemDescription" placeholder="Enter Contact Number" name="patientContactNum" value="<?php echo $rs->patientContactNum; ?>">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="itemDescription" placeholder="Enter Email Address" name="patientEmailAdd" value="<?php echo $rs->patientEmailAdd; ?>">
                                        </div> 
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php } ?>   
                                <button  type="submit" class="btn btn-primary " style="width:100%; margin-bottom:8px">UPDATE PATIENT INFORMATION</button>
